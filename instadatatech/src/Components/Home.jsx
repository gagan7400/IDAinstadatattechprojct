...
export default function Home() {
  ...
  return (
    ...
    <div classNameName='' style={{...background }}>
      ...
      <div className=" gy-4 d-flex flex-wrap align-items-center p-lg-5">
        <div className="col-lg-6 p-lg-5 ">
          <div className="banner-left__content">
            ...
            <h2 className='text-uppercase mt-4 mb-4'style={{fontWeight:'700',fontSize:'45px',fontFamily: "'Roboto', sans-serif" }}>Innovate, Analyze, Develop: We Do It All</h2>
            ...
            <a target="_blank" className="btn btn--base me-2 mb-2 text-light" style={{fontFamily: "'Roboto', sans-serif",borderStyle:'none' ,background:' linear-gradient(90deg, rgba(81,85,251,1) 24%, rgba(25,209,253,1) 99%, rgba(220,187,247,1) 100%)'}} >
